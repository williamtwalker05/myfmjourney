...
export default function DemoPage() {
  ...
  const topAssisters = [...demoSeasons]
    ...
    <main className="min-h-screen bg-[#0a0a0a] px-6 py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-green-500/10 border border-green-500/30 text-green-400 text-sm px-4 py-3 rounded-xl mb-8 flex items-center justify-between flex-wrap gap-3">
          ...
          <Link href="/" className="bg-green-500 hover:bg-green-400 text-black font-bold px-4 py-1.5 rounded-lg text-sm transition-colors">
            Get Started
          </Link>
        </div>

        <div className="bg-[#141414] border border-white/10 rounded-2xl px-6 py-5 mb-8">
          <p className="text-green-400 text-sm font-semibold uppercase tracking-widest mb-1">{demoSave.club}</p>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#141414] border border-white/10 rounded-2xl p-6 text-center">
            ...
            <Link href="/" className="inline-block bg-green-500 hover:bg-green-400 text-black font-bold px-8 py-3 rounded-xl transition-colors">
